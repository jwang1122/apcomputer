...
//		}
	...
	public void init(Integer[] ph, MechanicalArm arm) {
...
//		List<Integer> list = Arrays.asList(ph);
//		setSolutions(list);
		setArm(arm);
	}
	
	public static void main(String[] args) {
		Integer[] ph = { 7, 4, 10, 5, 6, 7, 13 };
...
//		exp.mostAcidic();  // part (b)
		...
		ph = new Integer[]{ 11, 9, 8, 8, 12, 13, 14 }; // no most acide existing
